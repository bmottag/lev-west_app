...
<?php }else { ?>
					<a href="<?php echo base_url("jobs/add_workers_training/" . $jobInfo[0]["id_job"]); ?>" class="btn btn-success btn-block"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add Lev West Workers</a>
