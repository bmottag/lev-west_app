    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-warning">
				...
				<a class="btn btn-warning btn-xs" href=" <?php echo base_url($dashboardURL); ?> "><span class="glyphicon glyphicon glyphicon-chevron-left" aria-hidden="true"></span> My Work Space </a> 
